...
public class AccountController {
	...
	@GetMapping("/account")
	public String viewsDetail(@AuthenticationPrincipal ShophyolUserDetails loggedUser, Model model) {
	...
	public String saveDetails(User user, RedirectAttributes redirectAttributes,
			@AuthenticationPrincipal ShophyolUserDetails loggedUser, @RequestParam("image") MultipartFile multipartFile)
			throws IOException {
