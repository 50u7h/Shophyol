...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("SITE_NAME", "Shophyol", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "Shophyol.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2023 Shophyol Ltd.", SettingCategory.GENERAL);
